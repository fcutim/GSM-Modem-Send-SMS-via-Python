...
while ans:
    ...
    if ans=="status":
        ...
        print("Fehler! 0x80071AC3") # Fehler Nachricht, falls ein Fehler auftreten sollte. (Kann frei definiert werden) (Außer der Fehler Code!)
...
phone = serial.Serial("COM7",  9600, timeout=5)
